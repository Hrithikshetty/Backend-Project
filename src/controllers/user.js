...
const changeCurrentUserPassword = asyncHandler(async(res,req)=>{
  ...
  //from middleware because user is logined and changing his password we can take from req.user
...
export { registerUser, loginUser, logoutUser ,refreshAccessToken, changeCurrentUserPassword ,getCurrentUser ,updateAccountDetails,updateUserAvatar };
